/*
int main() {
    char dizi1[] = {'a'};  // 'a' karakterini içeren bir char dizisi
    
    // dizi1[0] bir karakter olduğu için, %d formatı ile karakterin ASCII değeri yazdırılır
    printf("ASCII değeri: %d\n", dizi1[0]);  // 97 yazdırır
    
    // Alternatif olarak, %c formatı ile karakterin kendisini yazdırabilirsin
    printf("Karakterin kendisi: %c\n", dizi1[0]);  } // 'a' yazdırır
